...
export default function Checkout() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    toast.success(
      "Order Made Successfully. Do not click again. Please be patient. We are processing your information. You will be redirected to WhatsApp"
    );
  ...
  return (
    <>
      <Head>
        <title>Checkout - Ohreassa Technology</title>
      ...
      <form className="w-full px-5 lg:px-20 my-5" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center my-10">
          {total > 0 ? (
            ...
            <div>
              ...
              <Link href={"/shop"}>
                <div className="bg-mainPurple text-white font-semibold text-center rounded-full my-10 py-3">
                  Go To Shop
                </div>
              </Link>
            </div>
        ...
        {total > 0 && (
          <button
            className="w-full bg-mainPurple text-white font-medium tracking-wide py-3 rounded-lg"
            type="submit"
          >
            MAKE ORDER
          </button>
