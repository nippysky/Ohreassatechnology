      ...
      <section className="w-full px-5 lg:px-32 py-3 mt-3">
        ...
        <section className="w-full flex-col lg:flex lg:flex-row gap-10 my-10">
          ...
          >
            ...
            <Link
              ...
              href={`https://api.whatsapp.com/send?phone=2348020631346&text=Hi%20*Ohreassa.*%20I%20am%20interested%20in%20*${quantity}*%20of%20the%20*${
                product.name
              }*%20${
                variation === "" ? "" : variation
              }%20for%20*₦${getVariationPrice()}*%20in%20your%20store.`}
            >
              <button className="w-full bg-[#25D366] text-center font-semibold text-white py-4 my-3 active:bg-mainYellow rounded-full">
                Buy From Whatsapp
              </button>
            </Link>
            ...
            {/* Add To Cart Button */}
            <button
              className="w-full bg-mainPurple text-center font-semibold text-white py-4 my-3 active:bg-mainYellow rounded-full"
        ...
        >
          ...
          <div className="w-full flex justify-center items-center mt-20">
            <Link href={"/shop"}>
              <button className="font-semibold border bg-mainPurple text-white text-center text-clayBrown py-3 px-20 rounded-full">
                Load More
              </button>
            </Link>
          </div>
